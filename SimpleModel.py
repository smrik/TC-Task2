...
X = data[['hour', 'minute', 'IDA1price', 'volumes', 'forecast_production', 'SIPXprice', 'da_load',
		  'shift_1d', 'forecast_consumption', 'shift_3d', 'shift_8d',
...
X = data2[['hour', 'minute', 'IDA1price', 'volumes', 'forecast_production', 'SIPXprice', 'da_load',
		  'shift_1d', 'forecast_consumption', 'shift_2d','shift_1w', 'HUprice', 'solar',
		  'DayOfWeek', 'holiday', 'shift_1d_IDA1']]
y = data2['IDA2price']
...
# Final prediction
split_date = '2024-11-17'  # Change this to your desired date if needed
# split_date = '2024-11-01'  # Change this to your desired date if needed
...
output.to_csv('data/forecasts/forecast_11-17.csv', header=False)
output
# %%
